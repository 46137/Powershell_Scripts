...
1. [Powershell Overview](#powershell-overview)
2. [Scanning](#scanning)
3. [Remoting](#remoting)
  - WinRM
  - WMIC
...
5. [Host Enumeration Tasks](#host-enumeration-tasks)
6. [Modules Framework Tasks](#modules-framework-tasks)
7. [Readme.md Tasks](#readmemd-tasks)
